...
try {
  switch (target) {
    ...
    case 'render':
      ...
      break;
    case 'rooms':
      await runCommand(node, ['--import', 'tsx', '--test', 'apps/web/test/plan-calibration.test.ts', 'apps/web/test/prepared-module-plan.test.ts', 'apps/web/test/vastu-readiness.test.ts', 'apps/web/test/wall-bay-editor.test.ts']);
