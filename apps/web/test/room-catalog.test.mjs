  ...
  vite = await createServer({
    ...
    resolve: {
      alias: {
        ...
        '@ultida/scene-core': resolve('packages/scene-core/src'),
        '@ultida/scene-compiler': resolve('packages/scene-compiler/src'),
        '@ultida/catalog-core': resolve('packages/catalog-core/src'),
      },
    },
