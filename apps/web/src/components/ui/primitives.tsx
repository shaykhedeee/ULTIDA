...
export function Badge({ children, className, tone = 'neutral' }: PropsWithChildren<{ className?: string; tone?: 'neutral' | 'success' | 'accent' | 'warn' }>) { return <span className={cn('ui-badge', `ui-badge-${tone}`, className)}>{children}</span>; }
