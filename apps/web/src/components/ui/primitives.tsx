...
export function WorkflowDock({
  ...
  totalStages: _totalStages = 5,
  stageTitle: _stageTitle,
  stageSummary: _stageSummary,
  prevAction: _prevAction,
  nextAction: _nextAction,
  secondaryAction: _secondaryAction,
  beaconTone: _beaconTone = 'gold',
  extraContent: _extraContent,
}: WorkflowDockProps) {
  // Authoritative stage progression and Prev/Next continuity is now exclusively handled
  // by the single Stage Progression Header in Shell.tsx.
  // Returning null eliminates the floating bottom overlay so that zero buttons are hidden or cut out.
  return null;
}
