...
export const IndianModularCatalog: CatalogModule[] = [
  ...
  { id: 'kit-wall-600', family: 'kitchen-wall', name: '600 wall cabinet with loft option', roomTypes: ['kitchen', 'utility'], widthMm: 600, depthMm: 350, heightMm: 720, minClearanceMm: 900, sku: 'ULT-KW-600', materialSlots: ['carcass', 'shutter', 'hardware', 'lighting'], tags: ['modular-kitchen', 'wall-unit', 'loft', 'shutter'], production: { panelBased: true, hardwareSchedule: true, cutlistSupported: true }, description: 'Upper storage module for equal shutters, glass shutters, or open shelf compositions.', manufacturingRules: ['Use 18mm carcass panels', 'Keep task-light clearance below wall units'] },
  { id: 'kit-corner-900', family: 'kitchen-corner', name: '900 blind-corner base unit', roomTypes: ['kitchen'], widthMm: 900, depthMm: 600, heightMm: 750, minClearanceMm: 1050, sku: 'ULT-KC-900', materialSlots: ['carcass', 'shutter', 'hardware', 'countertop'], tags: ['modular-kitchen', 'blind-corner', 'l-shaped'], production: { panelBased: true, hardwareSchedule: true, cutlistSupported: true }, description: 'Corner base for L and U kitchens with serviceable access and filler control.', manufacturingRules: ['Reserve corner filler before placement', 'Validate door swing and adjacent appliance clearance'] },
