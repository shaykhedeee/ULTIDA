...
export const CuratedLaminateCatalog = [
  // ─── HIGH-GLOSS & ACRYLIC LAMINATES (Glossy / Reflective Finishes) ───
  ...
  { id: 'merino-high-gloss-champagne', brand: 'Merino', name: 'High-Gloss Champagne Metallic (0.8mm)', family: 'solid', finish: 'glossy', colourHex: '#F0E6D2', thicknessMm: 0.8, budgetTier: 'standard', edgeBand: { thicknessMm: 1, material: 'PVC', status: 'required' }, suitableFor: ['wardrobe', 'tv-unit', 'bed'] },
  { id: 'stylam-polygloss-emerald', brand: 'Stylam', name: 'Mirror Polygloss Emerald Green (1.0mm)', family: 'solid', finish: 'glossy', colourHex: '#1B4D3E', thicknessMm: 1.0, budgetTier: 'luxury', edgeBand: { thicknessMm: 2, material: 'ABS', status: 'required' }, suitableFor: ['crockery', 'tv-unit', 'pooja'] },
  { id: 'merino-polygloss-cappuccino', brand: 'Merino', name: 'Polygloss Warm Cappuccino (1.0mm)', family: 'solid', finish: 'glossy', colourHex: '#A38D7D', thicknessMm: 1.0, budgetTier: 'standard', edgeBand: { thicknessMm: 1, material: 'PVC', status: 'required' }, suitableFor: ['kitchen', 'wardrobe', 'bed'] },

  // ─── SUPER-MATTE & ANTI-FINGERPRINT ZERO-G LAMINATES (Matte / Soft-Touch) ───
  ...
  { id: 'virgo-forest-green', brand: 'Virgo', name: 'Forest Green Anti-Fingerprint Matte (1.0mm)', family: 'solid', finish: 'matte', colourHex: '#38463A', thicknessMm: 1.0, budgetTier: 'luxury', edgeBand: { thicknessMm: 2, material: 'ABS', status: 'required' }, suitableFor: ['crockery', 'tv-unit', 'pooja'] },
  { id: 'advance-graphite-matte', brand: 'Advance', name: 'Graphite Suede Matte (0.8mm)', family: 'solid', finish: 'matte', colourHex: '#303234', thicknessMm: 0.8, budgetTier: 'standard', edgeBand: { thicknessMm: 1, material: 'PVC', status: 'required' }, suitableFor: ['kitchen', 'tv-unit', 'wardrobe'] },
  ...
  { id: 'cubex-blush-ivory', brand: 'Cubex', name: 'Blush Ivory Suede Soft Matte (0.8mm)', family: 'solid', finish: 'suede', colourHex: '#E8D9CC', thicknessMm: 0.8, budgetTier: 'standard', edgeBand: { thicknessMm: 1, material: 'PVC', status: 'required' }, suitableFor: ['bed', 'wardrobe', 'pooja'] },

  // ─── TEXTURED WOODGRAINS & SYNCHRONIZED VENEERS ───
  ...
  { id: 'cubex-charcoal-oak', brand: 'Cubex', name: 'Charcoal Oak Synchronized (1.0mm)', family: 'woodgrain', finish: 'textured', colourHex: '#34302B', thicknessMm: 1.0, budgetTier: 'luxury', edgeBand: { thicknessMm: 2, material: 'ABS', status: 'required' }, suitableFor: ['tv-unit', 'kitchen', 'study'] },
  ...
  { id: 'virgo-smoked-oak', brand: 'Virgo', name: 'Royal Smoked Oak (1.0mm)', family: 'woodgrain', finish: 'satin', colourHex: '#5A473B', thicknessMm: 1.0, budgetTier: 'luxury', edgeBand: { thicknessMm: 2, material: 'ABS', status: 'required' }, suitableFor: ['tv-unit', 'bed', 'crockery'] },
  { id: 'advance-bavarian-teak', brand: 'Advance', name: 'Synchronized Bavarian Teak (1.0mm)', family: 'woodgrain', finish: 'textured', colourHex: '#8C5832', thicknessMm: 1.0, budgetTier: 'luxury', edgeBand: { thicknessMm: 2, material: 'PVC', status: 'required' }, suitableFor: ['pooja', 'wardrobe', 'living'] },
  { id: 'merino-nordic-birch', brand: 'Merino', name: 'Light Nordic Birch Grain (1.0mm)', family: 'woodgrain', finish: 'textured', colourHex: '#D4B996', thicknessMm: 1.0, budgetTier: 'standard', edgeBand: { thicknessMm: 1, material: 'PVC', status: 'required' }, suitableFor: ['study', 'wardrobe', 'kids_bedroom'] },
  ...
  { id: 'advance-french-boiserie', brand: 'Advance', name: 'Parisian Boiserie Moulding Panel (18mm)', family: 'solid', finish: 'suede', colourHex: '#F0ECE1', thicknessMm: 18, budgetTier: 'luxury', edgeBand: { thicknessMm: 0, material: 'None', status: 'not_required' }, suitableFor: ['feature-wall', 'bedroom', 'living'] },
  { id: 'merino-suede-terracotta', brand: 'Merino', name: 'Textured Terracotta Suede Panel (1.0mm)', family: 'solid', finish: 'suede', colourHex: '#B85D43', thicknessMm: 1.0, budgetTier: 'luxury', edgeBand: { thicknessMm: 2, material: 'PVC', status: 'required' }, suitableFor: ['crockery', 'pooja', 'dining'] },

  // ─── BASE PLY & CORE BOARDS (Substrates & Carcass Cores) ───
  ...
  { id: 'action-tesa-hdhmr-12', brand: 'Action TESA', name: '12mm HDHMR Moisture Resistant Board', family: 'solid', finish: 'matte', colourHex: '#7D9984', thicknessMm: 12, budgetTier: 'standard', edgeBand: { thicknessMm: 1, material: 'PVC', status: 'required' }, suitableFor: ['kitchen', 'utility', 'wardrobe'] },
  ...
  { id: 'greenply-bwr-18', brand: 'Greenply', name: '18mm Ecotec BWR Grade Hardwood Plywood', family: 'woodgrain', finish: 'textured', colourHex: '#84613C', thicknessMm: 18, budgetTier: 'standard', edgeBand: { thicknessMm: 1, material: 'PVC', status: 'required' }, suitableFor: ['wardrobe', 'bed', 'living'] },
  { id: 'commercial-mr-18', brand: 'National Ply', name: '18mm IS:303 Commercial MR Grade Plywood', family: 'woodgrain', finish: 'textured', colourHex: '#A37F58', thicknessMm: 18, budgetTier: 'standard', edgeBand: { thicknessMm: 1, material: 'PVC', status: 'required' }, suitableFor: ['wardrobe', 'study', 'storage'] },
  { id: 'european-birch-ply-18', brand: 'Riga Ply', name: '18mm 13-Ply Calibrated European Birch Plywood', family: 'woodgrain', finish: 'satin', colourHex: '#D2B48C', thicknessMm: 18, budgetTier: 'luxury', edgeBand: { thicknessMm: 0, material: 'Exposed Multi-Ply', status: 'not_required' }, suitableFor: ['study', 'living', 'feature-wall'] },
  { id: 'interior-mdf-18', brand: 'Action TESA', name: '18mm Interior CNC Carving Grade MDF Board', family: 'solid', finish: 'matte', colourHex: '#C2A682', thicknessMm: 18, budgetTier: 'standard', edgeBand: { thicknessMm: 1, material: 'PVC', status: 'required' }, suitableFor: ['pooja', 'feature-wall', 'wardrobe'] },

  // ─── STONE & SINTERED SLABS ───
  ...
  { id: 'marquina-black-porcelain', brand: 'Laminam', name: '12mm Nero Marquina Black Porcelain Countertop', family: 'stone', finish: 'satin', colourHex: '#1E1E22', thicknessMm: 12, budgetTier: 'luxury', edgeBand: { thicknessMm: 0, material: 'Mitred Edge', status: 'not_required' }, suitableFor: ['kitchen', 'crockery', 'tv-unit'] },
  { id: 'advance-terrazzo-beige', brand: 'Advance', name: 'Venetian Terrazzo Beige (1.0mm)', family: 'stone', finish: 'textured', colourHex: '#BBA99B', thicknessMm: 1.0, budgetTier: 'luxury', edgeBand: { thicknessMm: 2, material: 'PVC', status: 'required' }, suitableFor: ['kitchen', 'crockery', 'study'] },
] as const;
