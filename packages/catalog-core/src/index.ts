...
export const CuratedLaminateCatalog = [
  // ─── 0.8MM STANDARD & HIGH-GLOSS LAMINATES (Value / Standard Budget) ───
  { id: 'merino-high-gloss-white', brand: 'Merino', name: 'High-Gloss Pure White (0.8mm)', family: 'solid', finish: 'glossy', colourHex: '#FFFFFF', thicknessMm: 0.8, budgetTier: 'standard', edgeBand: { thicknessMm: 1, material: 'PVC', status: 'required' }, suitableFor: ['kitchen', 'wardrobe', 'utility'] },
  { id: 'merino-high-gloss-champagne', brand: 'Merino', name: 'High-Gloss Champagne (0.8mm)', family: 'solid', finish: 'glossy', colourHex: '#F0E6D2', thicknessMm: 0.8, budgetTier: 'standard', edgeBand: { thicknessMm: 1, material: 'PVC', status: 'required' }, suitableFor: ['wardrobe', 'tv-unit', 'bed'] },
  { id: 'cubex-neutral-sand', brand: 'Cubex', name: 'Neutral Sand Matte (0.8mm)', family: 'solid', finish: 'matte', colourHex: '#C9B59B', thicknessMm: 0.8, budgetTier: 'standard', edgeBand: { thicknessMm: 1, material: 'PVC', status: 'required' }, suitableFor: ['wardrobe', 'tv-unit', 'crockery', 'bed'] },
  { id: 'cubex-blush-ivory', brand: 'Cubex', name: 'Blush Ivory Suede (0.8mm)', family: 'solid', finish: 'suede', colourHex: '#E8D9CC', thicknessMm: 0.8, budgetTier: 'standard', edgeBand: { thicknessMm: 1, material: 'PVC', status: 'required' }, suitableFor: ['bed', 'wardrobe', 'pooja'] },
  { id: 'advance-ivory-matte', brand: 'Advance', name: 'Ivory Matte (0.8mm)', family: 'solid', finish: 'matte', colourHex: '#E7E0D2', thicknessMm: 0.8, budgetTier: 'standard', edgeBand: { thicknessMm: 1, material: 'PVC', status: 'required' }, suitableFor: ['kitchen', 'wardrobe', 'pooja'] },
  { id: 'advance-graphite-08', brand: 'Advance', name: 'Graphite Suede (0.8mm)', family: 'solid', finish: 'suede', colourHex: '#303234', thicknessMm: 0.8, budgetTier: 'standard', edgeBand: { thicknessMm: 1, material: 'PVC', status: 'required' }, suitableFor: ['kitchen', 'tv-unit', 'wardrobe'] },
  ...
  // ─── 1.0MM PREMIUM & LUXURY ACRYLIC / TEXTURED LAMINATES (Luxury / Premium Budget) ───
  { id: 'royale-acrylic-gloss-cashmere', brand: 'Royale Touche', name: 'Ultra High-Gloss Cashmere Acrylic (1.0mm)', family: 'solid', finish: 'glossy', colourHex: '#E3DAC9', thicknessMm: 1.0, budgetTier: 'luxury', edgeBand: { thicknessMm: 2, material: 'ABS', status: 'required' }, suitableFor: ['kitchen', 'wardrobe', 'tv-unit'] },
  { id: 'royale-acrylic-gloss-anthracite', brand: 'Royale Touche', name: 'Ultra High-Gloss Anthracite (1.0mm)', family: 'solid', finish: 'glossy', colourHex: '#2C3038', thicknessMm: 1.0, budgetTier: 'luxury', edgeBand: { thicknessMm: 2, material: 'ABS', status: 'required' }, suitableFor: ['kitchen', 'tv-unit'] },
  ...
  { id: 'advance-stone-grey', brand: 'Advance', name: 'Stone Grey Anti-Scratch (1.0mm)', family: 'stone', finish: 'textured', colourHex: '#77736D', thicknessMm: 1.0, budgetTier: 'luxury', edgeBand: { thicknessMm: 2, material: 'PVC', status: 'required' }, suitableFor: ['kitchen', 'tv-unit', 'crockery'] },
