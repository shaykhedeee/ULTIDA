import { validateCanonicalPlan, setCanonicalPlanModel, getCanonicalPlanModel } from './dist/index.js';
const approved = {
...
setCanonicalPlanModel(approved);
console.log(validateCanonicalPlan(getCanonicalPlanModel()));
setCanonicalPlanModel(null);
console.log(validateCanonicalPlan(getCanonicalPlanModel()));
const bad = JSON.parse(JSON.stringify(approved));
delete bad.walls[0].heightMm;
setCanonicalPlanModel(bad);
console.log(validateCanonicalPlan(getCanonicalPlanModel()));
